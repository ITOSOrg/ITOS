...
<body>
    ...
    <div id="myaccordion">
        ...
        <div>
            ...
            <s:a href="%{CreateEmailAddressURL}">Create Email Address</s:a>
            <br>
            <br>
                    ...
                    <s:iterator value="emailAddressLinkDetailList" status="stat">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><s:url id="ReadEmailAddressURL" action="/ITOS/ReadEmailAddress"
                                        escapeAmp="false">
                                        <s:param name="emailAddressDetail.emailAddressID" value="%{emailAddressID}" />
                                        <s:param name="emailAddressLinkDetail.emailAddressLinkID"
                                            value="%{emailAddressLinkID}" />
                                    </s:url> <s:a href="%{ReadEmailAddressURL}">View</s:a> <s:url var="UpdateEmailAddressURL"
                                        action="/ITOS/ReadEmailAddress" escapeAmp="false">
                                        <s:param name="emailAddressDetail.emailAddressID" value="%{emailAddressID}" />
                                        <s:param name="emailAddressLinkDetail.emailAddressLinkID"
                                            value="%{emailAddressLinkID}" />
                                        <s:param name="emailAddressLinkDetail.relatedID" value="%{relatedID}" />
                                        <s:param name="act" value="%{updateAction}" />
                                    </s:url> <s:a href="%{UpdateEmailAddressURL}">Update</s:a> <s:url
                                        var="DeleteEmailAddressURL" action="/ITOS/DeleteEmailAddress" escapeAmp="false">
                                        <s:param name="emailAddressLinkDetail.emailAddressID" value="%{emailAddressID}" />
                                        <s:param name="emailAddressLinkDetail.emailAddressLinkID"
                                            value="%{emailAddressLinkID}" />
                                        <s:param name="emailAddressLinkDetail.relatedID" value="%{relatedID}" />
                                    </s:url> <s:a href="%{DeleteEmailAddressURL}">Delete</s:a></td>
