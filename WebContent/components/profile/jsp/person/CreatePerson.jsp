...
<s:form name="Registration" action="/ITOS/CreateUserSubmit" method="POST">
    ...
    <table>
        ...
        <tr>
            <td><s:select list="#{'Mr.':'Mr.', 'Mrs.':'Mrs.','Miss.':'Miss.', 'Kumar':'Kumar'}"
                name="personDetail.title" label="Title">
            </s:select></td>
        </tr>
        ...
        <tr>
            <td><s:select
                ...
                name="personDetail.emailAddressLinkDetail.typeCode" label="Type Code">
        ...
        <tr>
            <td><s:select
                list="#{'Primary':'Primary', 'Secondary':'Secondary', 'Persnal':'Persnal', 'Business':'Business'}"
                name="personDetail.phoneNumberLinkDetail.typeCode" label="Type Code">
        ...
        <tr>
            <td><s:select
                ...
                name="personDetail.addressLinkDetail.addressDetail.state" label="State">
        ...
        <tr>
            <td><s:select
                list="#{'Primary':'Primary', 'Secondary':'Secondary', 'Persnal':'Persnal', 'Business':'Business'}"
                name="personDetail.addressLinkDetail.typeCode" label="Type Code">
            </s:select></td>
        </tr>
        <tr>
            <td>PrimaryInd :</td>
        ...
        <tr>
            ...
            <td><br>
            <s:submit id="submit" type="submit" value="Submit" /></td>
