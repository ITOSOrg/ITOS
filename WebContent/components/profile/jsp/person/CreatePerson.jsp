...
<body>
    ...
    <div class="container" style="border: thin solid black">
        ...
        <h2>Person Detail</h2>
        <br>
        <s:form class="form-inline" name="Registration" action="/ITOS/CreateUserSubmit" method="POST" role="form"
            theme="bootstrap">
            ...
            <div class="form-group">
                <label>DateOfBirth:</label> <input type="text" id="datepicker1" class="dateTxt"
                    name="personDetail.dateOfBirth" />
            </div>
            <br>
            <br>
            ...
            <div class="form-group">
                ...
                <s:textfield type="text" name="personDetail.usersDetail.password" 
                    class="form-control" />
            </div>
            <br>
            <br>
            ...
            <br>
            <div class="form-group">
                <label>Start Date:</label> <input type="text" id="datepicker2" class="dateTxt"
                    name="personDetail.emailAddressLinkDetail.startDate" />
            </div>
            <div class="form-group">
                <label>End Date:</label> <input type="text" id="datepicker3" class="dateTxt"
            ...
            <div class="form-group">
                ...
                <s:textfield type="text" name="personDetail.phoneNumberLinkDetail.phoneNumberDetail.countryCode"
                    class="form-control" />
            </div>
            <div class="form-group">
                <label>Area Code:</label>
                <s:textfield type="text" name="personDetail.phoneNumberLinkDetail.phoneNumberDetail.areaCode"
                    class="form-control" />
            </div>
            <div class="form-group">
                <label>Phone Number:</label>
                <s:textfield type="text" name="personDetail.phoneNumberLinkDetail.phoneNumberDetail.phoneNumber"
                    class="form-control" />
            </div>
            <br>
            <br>
            <div class="form-group">
                ...
                <s:textfield type="text" name="personDetail.phoneNumberLinkDetail.phoneNumberDetail.extension"
                    class="form-control" />
            </div>
            <div class="form-group">
                <label>Type Code</label>
            ...
            <br>
            <div class="form-group">
                <label>Start Date</label> <input type="text" id="datepicker4" class="dateTxt"
                    name="personDetail.phoneNumberLinkDetail.startDate" />
            </div>
            <div class="form-group">
                <label>End Date</label> <input type="text" id="datepicker5" class="dateTxt"
            ...
            <div class="form-group">
                ...
                <s:textfield type="text" name="personDetail.addressLinkDetail.addressDetail.streetOne" maxlength="50"
                    class="form-control" />
            </div>
            <div class="form-group">
                <label>StreetTwo</label>
                <s:textfield type="text" name="personDetail.addressLinkDetail.addressDetail.streetTwo" maxlength="50"
                    class="form-control" />
            </div>
            <div class="form-group">
                <label>AptUnit</label>
                <s:textfield type="text" name="personDetail.addressLinkDetail.addressDetail.aptUnit" maxlength="20"
                    class="form-control" />
            </div>
            <br>
            <br>
            ...
            <div class="form-group">
                ...
                <s:select label="State" list="stateMap" name="personDetail.addressLinkDetail.addressDetail.state" class="form-control" />
            ...
            <div class="form-group">
                <label>Country</label>
                <s:textfield type="text" name="personDetail.addressLinkDetail.addressDetail.country"
                    class="form-control" />
            </div>
            <div class="form-group">
                <label>ZipCode</label>
                <s:textfield type="text" name="personDetail.addressLinkDetail.addressDetail.zipCode"
                    class="form-control" />
            </div>
            <div class="form-group">
                <label>Type Code</label>
            ...
            <div class="form-group">
                <label>PrimaryInd</label>
                <s:radio name="personDetail.addressLinkDetail.primaryInd" list="#{'1':'True','0':'false' }" value="1"></s:radio>
            </div>
            <div class="form-group">
                <label>Start Date</label> <input type="text" id="datepicker6" class="dateTxt"
                    name="personDetail.addressLinkDetail.startDate" />
            </div>
            <div class="form-group">
                <label>End Date</label> <input type="text" id="datepicker7" class="dateTxt"
                    name="personDetail.addressLinkDetail.endDate" />
            </div>
            <br>
            <br>
            ...
            <div class="form-group">
                <label>PrimaryInd</label>
                <s:radio name="personDetail.personIdentityDetail.primaryInd" list="#{'1':'True','0':'false' }" value="1"></s:radio>
            </div>
            <div class="form-group">
                <label>Type Code</label>
                <s:select
            ...
            <br>
            <div class="form-group">
                <label>Start Date</label> <input type="text" id="datepicker8" class="dateTxt"
                    name="personDetail.personIdentityDetail.startDate" />
            </div>
            <div class="form-group">
                <label>End Date</label> <input type="text" id="datepicker9" class="dateTxt"
