...
public class CreateKeyServerDAO {
	...
	public String CreateKeyServer(KeyServerDetail keyServerDetail) {
		...
		try {
			...
			String KeyServerSQLStr = "Insert into KeyServer (keysetCode, nextUniqueIdBlock, humanReadable, annotation, strategy, recordStatus, createdBy, createdOn, lastModifiedBy, lastModifiedOn, versionNo )"
