...
import com.company.itos.profile.codetableheader.dao.ListCodeTableHeaderDAO;
...
public class ListCodeTableHeader extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (codeTableHeaderList != null) {
			...
			pageForwardStr = "/components/profile/jsp/codeTableHeader/ListCodeTableHeader.jsp";
