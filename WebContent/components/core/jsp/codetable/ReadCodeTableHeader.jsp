...
<body>
    ...
    <s:form action="/ITOS/ReadCodeTableHeader" method="POST">
        ...
        <s:url id="CreatecodeTableItemURL" action="/ITOS/CreatecodeTableItem" escapeAmp="false">
            ...
            <s:param name="codeTableItemDetail.tableName" value="%{codeTableHeaderDetail.tableName}" />
        ...
        <table border=1>
            ...
            <s:iterator value="codeTableHeaderDetail.codeTableItemDetailList" status="false">
                    ...
                    <tr>
                        ...
                        <td><s:url id="ReadCodeTableItemURL" action="/ITOS/ReadCodeTableItem" escapeAmp="false">
                                <s:param name="codeTableItemDetail.tableName"
                                    value="%{codeTableHeaderDetail.codeTableItemDetailList.tableName}" />
                                <s:param name="codeTableItemDetail.code"
                                    value="%{codeTableHeaderDetail.codeTableItemDetailList.code}" />
                            </s:url> <s:a href="%{ReadCodeTableItemURL}">View</s:a> <s:url id="UpdateCodeTableItemrURL"
